...
<Steps>
  ...
  <Step>
    ...
    Update the documentation under *src/main/asciidoc*.
...
any maven version changes.`},{heading:"update-the-documentation",content:`Update the documentation under src/main/asciidoc.
This usually involves copying the latest from master branch and making version-particular
...
any maven version changes.`]})]}),e.jsxs(s,{children:[e.jsx(i.h4,{id:"update-the-documentation",children:"Update the documentation."}),e.jsxs(i.p,{children:["Update the documentation under ",e.jsx(i.em,{children:"src/main/asciidoc"}),`.
This usually involves copying the latest from master branch and making version-particular
