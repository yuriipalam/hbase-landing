...
`,d={title:"Preface",description:"This is the official reference guide for the HBase version it ships with."},h=[{href:"https://hbase.apache.org/apidocs/index.html"},{href:"https://issues.apache.org/jira/browse/HBASE"},{href:"http://asciidoc.org/"},{href:"https://issues.apache.org/jira/secure/CreateIssueDetails!init.jspa?pid=12310753&issuetype=1&components=12312132&summary=SHORT+DESCRIPTION"},{href:"/docs/contributing-to-documentation"},{href:"http://en.wikipedia.org/wiki/Fallacies_of_Distributed_Computing"},{href:"https://issues.apache.org/jira/browse/hbase"},{href:"mailto:private@hbase.apache.org"}],u={contents:[{heading:void 0,content:`Herein you will find either the definitive documentation on an HBase topic as of its
standing when the referenced HBase version shipped, or it will point to the location
in Javadoc or
...
_src/main/asciidoc directory of the HBase source. This reference guide is marked up
using AsciiDoc from which the finished guide is generated as part of the
'site' build target. Run`},{heading:"about-this-guide",content:`to generate this documentation.
Amendments and improvements to the documentation are welcomed.
Click
this link
to file a new documentation bug against Apache HBase with some values pre-selected.`},{heading:"contributing-to-the-documentation",content:`For an overview of AsciiDoc and suggestions to get started contributing to the documentation,
...
places throughout this guide. In the interest of clarity, here is a brief explanation
of what is generally meant by these phrases, in the context of HBase.`},{heading:"support-and-testing-expectations",content:"type: info"},{heading:"support-and-testing-expectations",content:`Commercial technical support for Apache HBase is provided by many Hadoop vendors.
This is not the sense in which the term support is used in the context of the
Apache HBase project. The Apache HBase team assumes no responsibility for your
HBase clusters, your configuration, or your data.`},{heading:"supported",content:`In the context of Apache HBase, supported means that HBase is designed to work
in the way described, and deviation from the defined behavior or functionality should
...
_src/main/asciidoc directory of the HBase source. This reference guide is marked up
using `,e.jsx(t.a,{href:"http://asciidoc.org/",children:"AsciiDoc"}),` from which the finished guide is generated as part of the
'site' build target. Run`]}),`
...
`,e.jsxs(t.p,{children:[`For an overview of AsciiDoc and suggestions to get started contributing to the documentation,
...
places throughout this guide. In the interest of clarity, here is a brief explanation
of what is generally meant by these phrases, in the context of HBase.`]}),`
`,e.jsx(o,{type:"info",children:e.jsxs(t.p,{children:[`Commercial technical support for Apache HBase is provided by many Hadoop vendors.
This is not the sense in which the term `,e.jsx(t.em,{children:"support"}),` is used in the context of the
Apache HBase project. The Apache HBase team assumes no responsibility for your
HBase clusters, your configuration, or your data.`]})}),`
