...
<Callout type="info" title="mapred and mapreduce">
  There are two mapreduce packages in HBase as in MapReduce itself: *org.apache.hadoop.hbase.mapred* and *org.apache.hadoop.hbase.mapreduce*.
  ...
  When in doubt or starting over, pick *org.apache.hadoop.hbase.mapreduce*.
  In the notes below, we refer to *o.a.h.h.mapreduce* but replace with
...
To give the MapReduce jobs the access they need, you could add \\_hbase-site.xml\\_to *\\$HADOOP\\_HOME/conf* and add HBase jars to the *\\$HADOOP\\_HOME/lib* directory.
...
In addition, it discusses other interactions and issues between HBase and MapReduce jobs.`},{heading:void 0,content:"type: info"},{heading:void 0,content:"title: mapred and mapreduce"},{heading:void 0,content:`There are two mapreduce packages in HBase as in MapReduce itself: org.apache.hadoop.hbase.mapred and org.apache.hadoop.hbase.mapreduce.
The former does old-style API and the latter the new mode.
The latter has more facility though you can usually find an equivalent in the older package.
Pick the package that goes with your MapReduce deploy.
When in doubt or starting over, pick org.apache.hadoop.hbase.mapreduce.
In the notes below, we refer to o.a.h.h.mapreduce but replace with
o.a.h.h.mapred if that is what you are using.`},{heading:"hbase-mapreduce-and-the-classpath",content:`By default, MapReduce jobs deployed to a MapReduce cluster do not have access to
either the HBase configuration under $HBASE_CONF_DIR or the HBase classes.`},{heading:"hbase-mapreduce-and-the-classpath",content:`To give the MapReduce jobs the access they need, you could add _hbase-site.xml_to $HADOOP_HOME/conf and add HBase jars to the $HADOOP_HOME/lib directory.
...
In addition, it discusses other interactions and issues between HBase and MapReduce jobs.`}),`
`,e.jsx(a,{type:"info",title:"mapred and mapreduce",children:e.jsxs(s.p,{children:["There are two mapreduce packages in HBase as in MapReduce itself: ",e.jsx(s.em,{children:"org.apache.hadoop.hbase.mapred"})," and ",e.jsx(s.em,{children:"org.apache.hadoop.hbase.mapreduce"}),`.
The former does old-style API and the latter the new mode.
The latter has more facility though you can usually find an equivalent in the older package.
Pick the package that goes with your MapReduce deploy.
When in doubt or starting over, pick `,e.jsx(s.em,{children:"org.apache.hadoop.hbase.mapreduce"}),`.
In the notes below, we refer to `,e.jsx(s.em,{children:"o.a.h.h.mapreduce"}),` but replace with
`,e.jsx(s.em,{children:"o.a.h.h.mapred"})," if that is what you are using."]})}),`
...
`,e.jsxs(s.p,{children:["To give the MapReduce jobs the access they need, you could add _hbase-site.xml_to ",e.jsx(s.em,{children:"$HADOOP_HOME/conf"})," and add HBase jars to the ",e.jsx(s.em,{children:"$HADOOP_HOME/lib"}),` directory.
